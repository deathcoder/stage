...
public class AAJournalTypeGG {

    protected List<AAArticleTypeGG> article = new Vector<AAArticleTypeGG>();
     ...
     * {@link AAArticleTypeGG }
     * 
     * 
     */
    public List<AAArticleTypeGG> getArticle() {
        if (article == null) {
            article = new Vector<AAArticleTypeGG>();
        }
        return this.article;
    }
