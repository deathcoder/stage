...
class NamespacePrefixMapperImpl extends NamespacePrefixMapper {
    ...
    public String getPreferredPrefix(String namespaceUri, String suggestion, boolean requirePrefix) {
        ...
        // and the namespace http://www.objectway.it/jaxb/namespaceprefix will use "nspref".
        if( "http://www.objectway.it/jaxb/namespaceprefix".equals(namespaceUri) )
            return "nspref";
    ...
    public String[] getPreDeclaredNamespaceUris() {
        return new String[] { "http://www.objectway.it/jaxb/namespaceprefix"};
    }
}
