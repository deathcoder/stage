 ...
 * generated in the it.objectway.stage.interfaces package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://interfaces.stage.objectway.it/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://interfaces.stage.objectway.it/", "getHelloWorldAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.objectway.stage.interfaces
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.stage.objectway.it/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.stage.objectway.it/", name = "getHelloWorldAsString")
