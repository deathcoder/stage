 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://endpoints.stage.objectway.it/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://endpoints.stage.objectway.it/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://endpoints.stage.objectway.it/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoints.stage.objectway.it/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
